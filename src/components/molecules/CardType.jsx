            ...
            <div className="p-4">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center">
                        <img src="/assets/star.svg" className="w-[20px] h-auto"/>
                ...
                <div className="flex justify-between items-center gap-4 mt-2 text-[12px] text-gray-600">
                    <span className="flex items-center gap-1"><img src="/assets/level.svg" alt="level" /> {level}</span>
                    <span className="flex items-center gap-1"><img src="/assets/modul.svg" alt="modul" />{modules} Modul</span>
                    <span className="flex items-center gap-1"><img src="/assets/time.svg" alt="time"/>{duration} Menit</span>
                </div>
