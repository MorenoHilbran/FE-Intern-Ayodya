          ...
          {datas.map((item) => (
            <tr key={item.id} className="h-10 text-center hover:bg-gray-100">
              ...
              <td className="flex px-4 py-2">
                <button className="text-white bg-[#6148FF] px-2 py-1 rounded-full cursor-pointer" onClick={() => onEdit(item)}>Ubah</button>
                <button className="text-white bg-[#FF0000] px-2 py-1 rounded-full ml-2 cursor-pointer" onClick={() => onDelete(item)}>Hapus</button>
              </td>
            </tr>
          ))}
        </tbody>
    ...
    <div className="ml-[69px] mr-[87px]">
      <div className="flex justify-between items-center px-8 py-4 bg-white text-black">
        ...
        <div className="flex gap-2">
          <button className="px-4 py-2 bg-[#6148FF] text-white rounded-full font-bold cursor-pointer" onClick={() => handleOpenForm()}>Tambah</button>
          <button className="px-4 py-2 bg-white border border-[#6148FF] text-[#6148FF] rounded-full hover:opacity-80 flex items-center gap-2 font-bold cursor-pointer">
            <img src="/assets/filter.svg" alt="Filter" />
            Filter
          </button>
          <button className="px-4 py-2 bg-white text-[#6148FF] rounded-full hover:opacity-80 cursor-pointer">
